...
IniFile:=A_ScriptDir "\Rift.ini" ; Define the .ini file name and location
...
; Read Spec File
;-----------------------------------  
FileRead, LastSpec, C:\Users\alan\Documents\AutoHotKey Macros\spec.tmp
...
RiftPath()
{
   ...
   {   
      RiftPath:="C:\Users\alan\Desktop\RIFT.lnk" 
   }
